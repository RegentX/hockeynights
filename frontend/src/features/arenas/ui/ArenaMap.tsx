...
import type {Arena, ArenaBookingMode} from '@/entities/arena'
import {createArenaMapIcon} from '@/features/arenas/lib/arenaMapIcon'
import {
  FitMoscowRegionBounds,
  FocusSelectedArena,
  MapResizeFix,
  MoscowInitialView,
} from '@/features/arenas/ui/ArenaMapControls'
import {
  MOSCOW_MAP_CENTER,
