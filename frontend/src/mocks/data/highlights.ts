...
export let mockHighlights: Highlight[] = [
  ...
  },
  {
    ...
    authorDisplayName: 'Козлов Дмитрий Александрович',
  ...
  },
  {
    ...
    authorDisplayName: 'Волков Сергей Николаевич',
    title: 'Сэйв вратаря',
...
export function createMockHighlight(payload: CreateHighlightPayload): Highlight {
  const highlight: Highlight = {
    id: `hl-${Date.now()}`,
    ...payload,
    authorDisplayName: payload.authorUserId === 'user-001' ? 'Петров Иван Сергеевич' : 'Игрок',
