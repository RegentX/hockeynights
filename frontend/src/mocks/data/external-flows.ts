...
function createSeedBookings(): IceBookingRequest[] {
  ...
  return [
    ...
    },
    {
      ...
      arenaId: 'arena-001',
      arenaName: 'Ледовый дворец на Ходынке',
      slotId: 'slot-org-ready-1',
      slotLabel: 'Ср 20:00–21:30 · 15000 RUB',
      status: 'booked',
      externalUrl: 'https://example-arena.ru',
      ...
      priceRub: 15000,
      startsAt: '2026-08-19T20:00:00+03:00',
      endsAt: '2026-08-19T21:30:00+03:00',
    },
    {
      id: 'booking-org-draft-001',
      arenaId: 'arena-001',
      arenaName: 'Ледовый дворец на Ходынке',
      status: 'draft',
      externalUrl: 'https://example-arena.ru',
      confirmationCode: 'ICE-ORG-DFT',
      createdAt: new Date(now - 900000).toISOString(),
      updatedAt: new Date(now - 600000).toISOString(),
      requester: buildPersonRequester('user-001', {
        phone: '+7 (999) 100-11-22',
        roleLabel: 'Организатор тренировок',
      }),
      headcount: '10–12',
      purpose: 'Черновик заявки',
      comment: 'Ещё выбираю время — не отправлял на арену',
      priceRub: 14000,
    },
    {
      id: 'booking-org-pending-001',
      arenaId: 'arena-001',
      arenaName: 'Ледовый дворец на Ходынке',
      slotId: 'slot-org-pending-1',
      slotLabel: 'Чт 19:00–20:30 · 15000 RUB',
      status: 'pending_review',
      externalUrl: 'https://example-arena.ru',
      confirmationCode: 'ICE-ORG-NEW',
      createdAt: new Date(now - 3600000).toISOString(),
      updatedAt: new Date(now - 3600000).toISOString(),
      requester: buildPersonRequester('user-001', {
        phone: '+7 (999) 100-11-22',
      ...
      headcount: '14',
      purpose: 'Набор в открытую тренировку',
      comment: 'Отправил заявку — жду ответа арены',
      priceRub: 15000,
      startsAt: '2026-08-20T19:00:00+03:00',
      endsAt: '2026-08-20T20:30:00+03:00',
    },
    {
      id: 'booking-org-neg-001',
      arenaId: 'arena-001',
      arenaName: 'Ледовый дворец на Ходынке',
      slotId: 'slot-org-neg-1',
      slotLabel: 'Пт 21:00–22:30 · 16000 RUB',
      status: 'confirmed',
      externalUrl: 'https://example-arena.ru',
      confirmationCode: 'ICE-ORG-NEG',
    ...
    },
    {
      ...
      arenaId: 'arena-001',
      arenaName: 'Ледовый дворец на Ходынке',
      slotId: 'slot-org-pay-1',
      slotLabel: 'Пн 18:00–19:30 · 13000 RUB',
      status: 'awaiting_payment',
      externalUrl: 'https://example-arena.ru',
      confirmationCode: 'ICE-ORG-PAY',
      createdAt: new Date(now - 100000000).toISOString(),
      updatedAt: new Date(now - 40000000).toISOString(),
      requester: buildPersonRequester('user-001', {
        phone: '+7 (999) 100-11-22',
        roleLabel: 'Организатор тренировок',
      }),
      headcount: '12',
      purpose: 'Вечерняя раскатка',
    ...
    },
    {
      ...
      arenaId: 'arena-001',
      arenaName: 'Ледовый дворец на Ходынке',
      slotId: 'slot-org-ready-2',
      slotLabel: 'Сб 10:00–11:30 · 12000 RUB',
      status: 'booked',
      externalUrl: 'https://example-arena.ru',
      confirmationCode: 'ICE-ORG-RDY1',
    ...
    },
    {
      ...
      slotId: 'slot-org-ready-3',
      slotLabel: 'Вс 19:00–20:30 · 9000 RUB',
      status: 'booked',
      externalUrl: 'https://mytishchi.example.ru',
      confirmationCode: 'ICE-ORG-RDY2',
      createdAt: new Date(now - 200000000).toISOString(),
    ...
    },
    {
      ...
      status: 'declined',
      externalUrl: 'https://luzhniki.example.ru',
      confirmationCode: 'ICE-ORG-DEC',
      createdAt: new Date(now - 400000000).toISOString(),
      updatedAt: new Date(now - 300000000).toISOString(),
      requester: buildPersonRequester('user-001', {
        phone: '+7 (999) 100-11-22',
        roleLabel: 'Организатор тренировок',
      }),
      headcount: '14',
      purpose: 'Открытая тренировка',
      comment: 'Не подошло время',
      declineReason: 'Слот занят внутренней программой',
      priceRub: 11000,
      startsAt: '2026-08-18T12:00:00+03:00',
      endsAt: '2026-08-18T13:30:00+03:00',
    },
  ]
}
