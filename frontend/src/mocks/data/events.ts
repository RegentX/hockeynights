...
import {nextWeekday, relativeDate} from '@/mocks/data/relativeDate'
  ...
  return [
    {
      ...
      /** Лиговая суббота — день недели тут часть смысла, см. LEAGUE_SATURDAY_EVENT_ID. */
      startsAt: nextWeekday(6, '16:00'),
      endsAt: nextWeekday(6, '17:30'),
      arenaId: 'arena-001',
      ...
      accessScope: 'public',
      organizerDisplayName: 'Петров Иван Сергеевич',
    ...
    },
    {
      ...
      startsAt: relativeDate(9, '20:00'),
      endsAt: relativeDate(9, '21:30'),
      arenaId: 'arena-001',
      arenaName: 'Ледовый дворец на Ходынке',
      organizerUserId: 'user-001',
      teamId: 'team-001',
      ...
      participation: [
        {
          ...
          userId: 'user-001',
          displayName: 'Петров Иван Сергеевич',
          /** Не запись: организатор без confirmed — иначе «Мои записи» врёт */
          status: 'not_going',
    ...
    },
    {
      ...
      startsAt: relativeDate(-71, '19:00'),
      endsAt: relativeDate(-71, '20:30'),
      arenaId: 'arena-001',
      arenaName: 'Ледовый дворец на Ходынке',
      organizerUserId: 'user-001',
      teamId: 'team-001',
    ...
    },
    {
      ...
      startsAt: relativeDate(1, '08:00'),
      endsAt: relativeDate(1, '09:30'),
      arenaId: 'arena-002',
    ...
    },
    {
      ...
      startsAt: relativeDate(11, '07:00'),
      endsAt: relativeDate(11, '08:00'),
      arenaId: 'arena-002',
      arenaName: 'Каток «Лужники»',
      organizerUserId: 'user-001',
    ...
    },
    {
      ...
      startsAt: relativeDate(7, '19:00'),
      endsAt: relativeDate(7, '20:30'),
      arenaId: 'arena-001',
      arenaName: 'Ледовый дворец на Ходынке',
      ...
      accessScope: 'private_club',
      clubId: 'club-001',
      organizerDisplayName: 'Орлов Михаил Викторович',
    ...
    },
    {
      ...
      startsAt: relativeDate(3, '20:30'),
      endsAt: relativeDate(3, '22:00'),
      arenaId: 'arena-001',
      arenaName: 'Ледовый дворец на Ходынке',
      ...
      organizerDisplayName: 'Козлов Дмитрий Александрович',
    ...
    },
    {
      ...
      startsAt: relativeDate(5, '21:00'),
      endsAt: relativeDate(5, '22:30'),
      arenaId: 'arena-003',
      ...
      lifecycleStatus: 'published',
      accessScope: 'public_open',
      organizerDisplayName: 'Новиков Павел Андреевич',
